...
public class TeleportCommand extends CommandAreaShop {
	...
	public String getHelp(CommandSender target) {
		if (target.hasPermission("areashop.teleportall")) return plugin.getLanguageManager().getLang("help-teleportAll");
		else if (target.hasPermission("areashop.teleport")) return plugin.getLanguageManager().getLang("help-teleport");
		return null;
	}
