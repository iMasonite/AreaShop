...
public class SetdurationCommand extends CommandAreaShop {
	...
	public String getHelp(CommandSender target) {
		if (target.hasPermission("areashop.setduration")) return plugin.getLanguageManager().getLang("help-setduration");
		return null;
	}
	...
	public void execute(CommandSender sender, Command command, String[] args) {
		...
		if (!sender.hasPermission("areashop.setduration") && !rent.isLandlord(((Player) sender).getName())) {
