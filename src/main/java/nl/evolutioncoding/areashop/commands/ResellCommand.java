...
public class ResellCommand extends CommandAreaShop {
	...
	public String getHelp(CommandSender target) {
		if (target.hasPermission("areashop.resellall")) return plugin.getLanguageManager().getLang("help-resellAll");
		else if (target.hasPermission("areashop.resell")) return plugin.getLanguageManager().getLang("help-resell");
		return null;
	}
