...
public class StopresellCommand extends CommandAreaShop {
	...
	public String getHelp(CommandSender target) {
		if (target.hasPermission("areashop.stopresellall")) return plugin.getLanguageManager().getLang("help-stopResellAll");
		else if (target.hasPermission("areashop.stopresell")) return plugin.getLanguageManager().getLang("help-stopResell");
		return null;
	}
